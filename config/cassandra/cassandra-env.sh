...
calculate_heap_sizes()
{
    ...
    max_heap_size_in_mb="640" # OVERRIDE FOR ODROID
...
# Redirect the Java tmp dir due to noexec on /tmp and to save memory since /tmp on the
# daft cluster nodes is limited to 2GB and /tmp is set to use up to 500MB of that.
